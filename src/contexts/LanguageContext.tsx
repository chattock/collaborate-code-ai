...
const translations = {
  ...
  zh: {
    ...
    'projects.website': '网站',
    'projects.github': 'Github',
    'projects.videoDemo': '视频演示',
    'projects.project': '项目',
    'projects.report': '报告',
    'projects.ukTrade': '18世纪英国贸易',
    'projects.wordRelations': '词汇关系项目',
    'projects.globalTemps': '全球气温',
    'projects.battleSkies': '天空之战演示',
    'projects.orsted': 'Orsted项目',
    'projects.fashionESG': '时尚ESG分析',
    'projects.retailAnalytics': '零售分析仪表板',
    'projects.mlNetwork': '机器学习网络分析',
    'projects.propertyAnalysis': '房产分析工具',
    'projects.supplyChain': '供应链优化',
    'projects.sentimentAnalysis': '情感分析平台',
